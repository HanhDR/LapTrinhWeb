...
namespace _19T1021067.Web.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public ActionResult Index()
            {
            Models.OrderSearchIntput condition = Session[ORDER_SEARCH] as Models.OrderSearchIntput;
            if (condition == null)
            {
                condition = new Models.OrderSearchIntput()
                {
                    Page = 1,
                    PageSize = PAGE_SIZE,
                    SearchValue = "",
         ...
         public ActionResult Search(Models.OrderSearchOutput condition)
        {
                int rowCount = 0;
